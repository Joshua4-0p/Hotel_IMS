...
const SEED_BOOKINGS: AdminBooking[] = [
  ...
  { id: 'ab_03', roomId: 'lodr-signature',        roomName: 'Lodr Signature',        roomImage: 'https://images.unsplash.com/photo-1578683010236-d716f9a3f461?q=80&w=400', guestName: 'Ngozi Tagne',       guestEmail: 'ngozi.tagne@email.com',    guestPhone: '+237 699 003 003', checkIn: '2026-05-22', checkOut: '2026-05-25', guests: 1, totalPrice: 1530960, status: 'checked_in',  bookedAt: '2026-05-10T11:00:00', source: 'online' },
